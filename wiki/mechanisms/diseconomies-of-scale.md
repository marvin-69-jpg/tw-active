...
- 引用文獻（尚未抓）：
  - Berk & Green (2004) "Mutual Fund Flows and Performance in Rational Markets" *JPE*
  - Chen, Hong, Huang, Kubik (2004) "Does Fund Size Erode Mutual Fund Performance?" *AER*
  - Pastor, Stambaugh, Taylor & Zhu (2021) "Diseconomies of Scale in Active Management: Robust Evidence" SSRN 3886275
